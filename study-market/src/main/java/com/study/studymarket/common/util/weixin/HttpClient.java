...
//import com.gold.utils.JsonUtil;
...
public class HttpClient {
   ...
   * @throws Exception
   */
  public int sendPost(Map<String, String> data,String client) throws Exception {
    return this.sendPost(data, null,client);
  }
	 ...
	 * @throws Exception
	 */
	public int sendPost(Map<String, String> data, String encoding,String client) throws Exception {
		try {
      if (StringUtils.isEmpty(encoding)) {
        encoding = "UTF-8";
      }
			HttpURLConnection httpURLConnection = createConnection(encoding,client);
			if(null == httpURLConnection){
				throw new Exception("创建联接失败");
			}
			logger.info("请求明文:{}", JsonUtil.setMap2String(data));
			...
			//直连接口使用
			this.sign = httpURLConnection.getHeaderField("sign");
  ...
  public int sendGet() throws  Exception {
	 ...
	 */
	private HttpURLConnection createConnection(String encoding,String client) throws ProtocolException {
		...
		httpURLConnection.setRequestProperty("client",client);
